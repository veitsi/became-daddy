(function () {
    ...
    app.controller('PledgeController', function () {
        ...
        this.events = [
            ...
            {title: 'Levi9 PHP Tuesday ', price: 35, date: new Date(2015, 06, 14), registred: true, img: "img/inter.jpg",
            ...
            {title: 'как начать свой стартап', price: 40, date: new Date(2015, 06, 12), registred: false, img: "img/inter.jpg",
